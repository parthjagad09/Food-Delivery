...
const placeOrder = async (req, res) => {
    ...
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            mode: 'payment',
            success_url: `https://food-delivery-7phs.vercel.app/verify?success=true&orderId=${newOrder._id}`,
            cancel_url: `https://food-delivery-7phs.vercel.app/verify?success=false&orderId=${newOrder._id}`,
        });
